...
////// Emissive:
                float3 emissive = ((_coloradd.rgb*_df_var.rgb)+((_color.rgb*_df_var.rgb)*(attenuation+((1.0 - attenuation)*_shadowcolor.rgb))));
