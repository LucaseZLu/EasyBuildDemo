    ...
    public class BuildStorageInspector : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (BaseFoldout)
            {
                ...
                EditorGUILayout.PropertyField(serializedObject.FindProperty("SavePrefabs"), new GUIContent("Save All Parts :", "This allows to save all the prefabs after have exited the scene."));

                EditorGUILayout.PropertyField(serializedObject.FindProperty("LoadPrefabs"), new GUIContent("Load All Parts :", "This allows to save all the prefabs at startup of the scene."));
            ...
            GUILayout.Label("Build Storage Editor Loader", EditorStyles.largeLabel);
