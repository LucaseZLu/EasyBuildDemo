        ...
        public override void OnInspectorGUI()
        {
            ...
            if (ModesFoldout)
            {
                ...
                if (serializedObject.FindProperty("UseEditionMode").boolValue)
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("ResetModeAfterEdition"), new GUIContent("Reset Mode After Edition Action :", "This allows to reset the mode to (None) after the edition."));
            }
